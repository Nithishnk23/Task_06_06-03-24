...
const movieDetails = new movie("Leo","Sevan Screen Studios", "PG-14");
...
const movie1 = new movies("Leo","Sevan Screen Studios");
console.log(movie1);



const movie2 = new movies("Leo","Sevan Screen Studios","PG-14");
console.log(movie2);
...
let moviee1 = new Moviee("Leo", "Seven Screen Studios", "PG");
let moviee2 = new Moviee("Varisu", "Sri Venkateswara Creations", "V");
let movie3 = new Moviee("Jailer", "Sun Pictures", "PG");
let movie4 = new Moviee("Vikram", "Raj kamal films", "PG-13");
let movie5 = new Moviee("Thunivu", "Zee studios", "PG");
